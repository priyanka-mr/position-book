      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {tradeEvents.map((trade, index) => (
          ...
          >
            ...
            <div className="flex flex-col items-start">
              <p className="mb-1 text-xs">TradeEvent</p>
              <select
                value={trade.action}
                onChange={(e: any) =>
            ...
            <div className="flex flex-col items-start">
              <p className="mb-1 text-xs">Account</p>
              <input
                type="text"
            ...
            <div className="flex flex-col items-start">
              <p className="mb-1 text-xs">Security</p>
              <input
                type="text"
                placeholder="Enter the Security"
                value={trade.security}
                onChange={(e: any) =>
                  handleinputChange(index, 'security', e.target.value)
                }
                required
                className="p-2 border border-gray-400 rounded-sm h-10 w-40"
              />
            ...
            <div className="flex flex-col items-start">
              <p className="mb-1 text-xs">Quantity</p>
              <input
                type="number"
